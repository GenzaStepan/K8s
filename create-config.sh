...
# master01 hostname
export K8SHA_HOSTNAME1=ubuntu

# master02 hostname
export K8SHA_HOSTNAME2=kubmaster2

# master03 hostname
export K8SHA_HOSTNAME3=kubmaster3

#etcd tocken:
export ETCD_TOKEN=3489bf61bdfe1b3ae077d6fd9e7efefd
